...
| `well404.WebPanel` | [Web 管理面板](well404.WebPanel.md) — 通用可视化管理面板(供各插件挂载模块)+ 面向玩家的网页界面(`/menu`:服务器介绍、商店买卖、钱包转账、实用工具);路径式 token 鉴权 + 可选内置反代(cloudflared/ngrok,需管理员预装 cloudflared);**网页中英双语可切换** |
