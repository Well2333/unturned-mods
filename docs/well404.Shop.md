...
| `/buy <id> [数量]` | 购买：普通商品填**物品 ID**，礼包填**礼包 id**（仅玩家）。 | `well404.Shop:commands.buy` |
| `/sell <id> [数量]` | 出售：普通商品填**物品 ID**，礼包填**礼包 id**（仅玩家）。 | `well404.Shop:commands.sell` |
