    ...
    public class ShopPlugin : OpenModUnturnedPlugin
    {
        ...
        private void RegisterPlayerMenu()
        {
            ...
            m_PlayerCommandRegistry.Register("well404.shop", new[]
            {
                ...
                new PlayerCommandInfo("/buy <id> [amount]", "Buy an item by its game item id with your money.", "well404.Shop:commands.buy", "Shop"),
                new PlayerCommandInfo("/sell <id> [amount]", "Sell an item by its game item id back to the shop for money.", "well404.Shop:commands.sell", "Shop")
            });
