...
namespace well404.AdminTools
{
    ...
    internal static class WebI18n
    {
        ...
        public static readonly IReadOnlyDictionary<string, string> ZhTable = new Dictionary<string, string>
        {
            ...
            ["Repair equipment"] = "维修装备",
            ["Restore all durability-bearing equipment on an online player to 100%."] = "将指定在线玩家身上所有有耐久的装备恢复到 100%。",
            ["Kick"] = "踢出",
            ["Reason"] = "原因",
            ...
            ["Repaired {0} equipment item(s) for {1}."] = "已将 {1} 的 {0} 件装备维修到 100%。",
            ["All equipment for {0} is already at 100%."] = "{0} 的所有装备耐久已经是 100%。",
            ["Kicked {0}."] = "已踢出 {0}。",
