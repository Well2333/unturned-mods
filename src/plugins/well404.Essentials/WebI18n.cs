...
namespace well404.Essentials
{
    ...
    internal static class WebI18n
    {
        ...
        public static readonly IReadOnlyDictionary<string, string> ZhTable = new Dictionary<string, string>
        {
            ...
            ["Teleport"] = "传送",
            ["Teleport to {0}?"] = "确定传送到 {0}？",
            ["Compact"] = "紧凑",
            ["Large"] = "宽大",
            ["Map size preference saved."] = "地图尺寸偏好已保存。",
            ...
            ["Teleport to your saved home?"] = "确定传送到已保存的家吗？",
            ["No death point to return to."] = "没有可返回的死亡点。",
            ["Return to your last death point?"] = "确定返回上次死亡地点吗？",
            ["That saved location belongs to a different map."] = "该保存位置属于另一张地图。",
            ["Warp not found."] = "找不到该传送点。",
            ["That warp belongs to a different map."] = "该传送点属于另一张地图。",
            ...
            ["Interactive warp map"] = "互动传送地图",
            ["Warp map visibility"] = "玩家地图可见方式",
            ["native"] = "遵循游戏原生地图权限",
            ["always"] = "始终允许查看",
            ["Map"] = "地图",
            ...
            ["Tags"] = "标签",
            ["Empty = current map"] = "留空=当前地图",
            ["public city safe"] = "例如：public city safe",
            ["Each warp can have several space-separated tags. Tags become read-only player filters. Drag filtered cards to set their relative player-panel order. Players still need permission well404.Essentials:well404.essentials.warps.<name>."]
                = "每个传送点可填写多个空格分隔标签；标签仅用于玩家过滤。在任一筛选下拖动卡片可调整这些传送点的相对顺序。玩家仍需对应的传送点权限。",
